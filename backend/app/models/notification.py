...
class Notification(Base):
    ...
    NOTIFICATION_TYPES = ("outbid", "auction_won", "auction_lost", "auction_sold", "auction_unsold", "seller_new_auction", "saved_search_match", "report_resolved", "report_dismissed", "auction_moderation_action")
    __table_args__ = (
