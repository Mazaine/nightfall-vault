  ...
  return (
    <section className="container page-shell contact-page" aria-labelledby="contact-title">
      ...
      <div className="support-grid">
        <article><h2>Gyors segítség</h2><p>A licitálás, villámár és az ötpereces szabály részletes leírása egy helyen.</p><Link className="text-link" to="/how-it-works">Szabályok</Link></article>
