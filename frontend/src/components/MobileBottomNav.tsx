...
const items = [
  ...
  { label: "Indítás", to: "/account/auctions#auction-create", icon: "+", primary: true },
...
export function MobileBottomNav() {
  ...
  return <nav className="mobile-bottom-nav" aria-label="Mobil gyorsnavigáció">{items.map((item) => {
    const isCreate = item.primary && location.pathname === "/account/auctions" && location.hash === "#auction-create";
